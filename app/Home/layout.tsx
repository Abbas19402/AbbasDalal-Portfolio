        ...
        <div className="h-screen w-full relative border-blue-500 justify-center items-center overflow-x-hidden">
            ...
            <div className="flex flex-row w-full h-full absolute justify-start items-start overflow-hidden">
                ...
                <div className="absolute w-full flex justify-center">
                    ...
                    <div className={`absolute overflow-hidden lg:top-10 transition-all duration-500 ${navActiveOnSmall ? "opacity-100" : "opacity-0 -z-10 lg:opacity-100 lg:z-0"} h-[100vh] lg:h-16 w-[100vw] lg:w-[40vw] bg-white/10 mx-auto backdrop-blur-xl lg:rounded-full flex flex-col gap-y-2 lg:flex-row justify-center lg:justify-around items-center`}>
                    {Nav.map((item, index) => (
