...
const ServiceBanner: React.FC<Props> = ({ title, description, list, animation, reverse }) => {
    ...
    return (
        <div className={`w-full flex flex-col-reverse ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} justify-between items-center  min-h-[70vh] px-5 lg:px-20 my-14 lg:my-0`}>
